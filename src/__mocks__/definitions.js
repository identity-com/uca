...
const definitions = [
  {
    identifier: 'myMockedId',
    description: 'myMockedId with wrong type',
    version: '1',
    type: 'WrongType',
    attestable: true,
  },
  {
    identifier: 'my:Mocked:Id2',
    description: 'myMockedId with string type',
    version: '1',
    type: 'String',
    attestable: true,
  },
  {
    identifier: 'my:Mocked:Id3',
    description: 'myMockedId with boolean type',
    version: '1',
    type: 'Boolean',
  },
  {
